...
<div class="flex h-full flex-col items-center justify-center p-8">
    <Card width="w-full max-w-sm min-w-72" accent="primary">
        <div class="grid grid-cols-[auto_1fr] place-items-center gap-x-2 gap-y-4 p-6">
            <div class="input-label">Amount</div>
            <input class="input rounded-xl" type="number" />
            <div class="input-label">Date</div>
            <input class="input rounded-xl" type="date" />
